...
describe('Helper', () => {
  ...
  it('should showStoredNotification', () => {
    ...
    showStoredNotification();
    expect(StorageService.exists('Notification')).toEqual('');
  });
  it('should showStoredNotification', () => {
  ...
  it('should logout', () => {
    ...
    StorageService.set('jwtToken', token);
    logout();
    expect(StorageService.exists('jwtToken')).toEqual('');
  });
  ...
  it('should convertUTCDateToLocalDate', () => {
    const date = new Date();
    expect(convertUTCDateToLocalDate(date)).toEqual(date);
  });
  it('should removeDuplicates', () => {
    const date = ['Ankit', 'ANkit', 'ANKIT'];
    const newarray = ['ankit'];
    expect(removeDuplicates(date)).toEqual(newarray);
  });
  it('should scrollToFirstError', () => {
    expect(scrollToFirstError('ankit')).toEqual(true);
  });
  it('should scrollToFirstError', () => {
    const value = makeName();
    expect(makeName()).not.toEqual(value);
  });
});
